...
;;; use as initial values of variables declared to have objects
;;; of a class as values but without any declared initial value.
(defmethod initialize-instance :after ((ob YTools-object) &key ((\:blank blank))
                                       &allow-other-keys)
